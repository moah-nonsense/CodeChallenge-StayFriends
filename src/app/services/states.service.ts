...
export class StatesService {
  ...
  // };
  statesVal = {};
  states = new BehaviorSubject<any>(this.statesVal);
  personCount = new BehaviorSubject<any>(this.statesVal);
  statesUrl = 'http://localhost:4200/api/bundesland.json';
  constructor(private http: HttpClient,
              private bundeslandData: Bundesland) {  }
  ...
  getPersonIndexCount(): Observable<any> {
